...
def run_Tutorial(window):
    ...
    Mpacket = {'Session':0,'SubjectID':"Tutorial",'Belief':False,'In':False,'Run':0,'Game':'Single Player','Trial':0,'P2_ID':0,'Group':'0'}
    ...
    balloonColor = os.getcwd() + '/Resources/Balloons/BlueBalloonFull.png'
